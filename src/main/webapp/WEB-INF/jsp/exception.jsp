...
<petclinic:layout pageName="error">
    <div class="modern-card" style="max-width: 680px; margin: 40px auto; text-align: center; padding: 48px 32px;">
        ...
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 14px; font-size: 13px; color: #475569; margin-bottom: 28px; text-align: left; word-break: break-all;">
            ...
            <div><strong>상세 메시지:</strong> <span style="color: #dc2626;"><c:out value="${exception.message}" default="상세 메시지가 없습니다."/></span></div>
        </div>
